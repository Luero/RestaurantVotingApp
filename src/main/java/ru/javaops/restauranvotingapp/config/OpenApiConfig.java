...
@OpenAPIDefinition(
        info = @Info(
                ...
                version = "1.0",
                description = """
                        Application that allows users to vote for restaurants where to have a meal
                        (<a href='https://github.com/Luero/RestaurantVotingApp'>Luero</a>)
                        <p><b>Credentials for test:</b><br>
                        - user@yandex.ru / password<br>
                        - admin@yandex.ru / admin<br>
                        - victor@yandex.ru / victor</p>
                        """,
